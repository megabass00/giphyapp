...
@Component({
  selector: 'app-chat-camouflage',
  templateUrl: './chat-camouflage.component.html',
  styleUrls: ['./chat-camouflage.component.css'],
  encapsulation: ViewEncapsulation.None,
})
export class ChatCamouflageComponent implements OnInit {
  ...
  public showGiphyPreview(giphy: Giphy) {

  }

  public hideGiphyPreview(giphy: Giphy) {
